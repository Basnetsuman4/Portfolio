...
const Hero: React.FC = () => {
	return (
		<section
			id="home"
			className="min-h-screen flex flex-col justify-center items-center text-center section-padding"
		>
			<div className="space-y-8 max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
				...
				<p className="text-xl md:text-2xl font-light text-stone-500 dark:text-stone-400 leading-relaxed max-w-2xl mx-auto">
					...
					<span className="text-stone-800 dark:text-stone-200 font-medium italic">
						Next.js
					</span>
					,{" "}
					<span className="text-stone-800 dark:text-stone-200 font-medium italic">
